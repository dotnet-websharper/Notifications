...
{
 "use strict";
 var WebSharper,Notifications,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Var,Handler,Unchecked,WebSharper$Notifications$Sample_Templates,TemplateHole,TemplateHoleModule,TextView,System,Guid,SC$1,EventQ,JavaScript,Pervasives,Concurrency,Promise,EventTarget,Client$1,Templates,Doc,Collections,Dictionary,Node,Var$1,Object,AsyncBody,CT,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,JS,VarDomElement,View,Numeric,ConcreteVar,Snap,Scheduler,Error,NonStandardPromiseRejectionException,SC$2,DictionaryUtil,Enumerator,T,WindowOrWorkerGlobalScope,SC$3,Docs,DocElemNode,CharacterData,Abbrev,Fresh,OperationCanceledException,CancellationTokenSource,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Text,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Anims,SC$4,HashSetUtil,SC$5,SC$6,SC$7,AppendList,DynamicAttrNode,KeyNotFoundException,SC$8,Easing,HashSet$1,BindVar,String,CheckedInput,DomNodes,Char,DateUtil,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,Notification,Promise$1,Runtime$1,console,Math,Date;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Notifications=WebSharper.Notifications=WebSharper.Notifications||{};
 Sample=Notifications.Sample=Notifications.Sample||{};
 ...
 WebSharper$Notifications$Sample_Templates=Global.WebSharper$Notifications$Sample_Templates=Global.WebSharper$Notifications$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_Notifications_Sample$Client=Global.StartupCode$WebSharper_Notifications_Sample$Client||{};
 ...
 {
  var _,b,t,s,_this,p,i;
  _=(b=(t=(s=Client.status().get_View(),(_this=new ProviderBuilder.New$1(),(_this.h.push(new TextView.New("status",s)),_this))),(t.h.push(Handler.EventQ2(t.k,"requestnotification",function()
  {
   return t.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.requestNotification()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$Notifications$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.requestNotification=function()
 {
  var _;
  function f()
  {
   function f$1()
   {
    return Notification.requestPermission().then(function(a)
    {
     var r;
     return a=="granted"?(Client.status().Set("Notifications sent!"),new Notification("Hello! Notifications are enabled.",(r={},r.body="This is a test notification.",r)),Promise$1.resolve(null)):(Client.status().Set("Notifications denied!"),Promise$1.resolve(null));
    });
   }
   function f$2(a)
   {
    Client.status().Set(Global.String(a.message));
 ...
 WebSharper$Notifications$Sample_Templates.main=function(h)
 {
